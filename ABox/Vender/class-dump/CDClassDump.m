...
//    CDMachOFile *machOFile = [[CDMachOFile alloc] initWithData:file.data filename:file.filename searchPathState:file.searchPathState];
    CDFatFile *fatFile = [[CDFatFile alloc] initWithData:file.data filename:file.filename searchPathState:file.searchPathState];
    NSLog(@"fatFile: %@", fatFile);
    CDMachOFile *machOFile = [fatFile machOFileWithArch:_targetArch];
